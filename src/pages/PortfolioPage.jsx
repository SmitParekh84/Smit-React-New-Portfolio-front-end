...
export const PortfolioPage = () => {
  ...
  const handleDeleteProject = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${import.meta.env.VITE_API_URL}/projects/${projectToDelete._id}`,
        {
          method: "DELETE",
          headers: {
  ...
  const portfolioSchema = {
    ...
    description:
      "A collection of web development and digital marketing projects by Smit Parekh",
    author: {
      "@type": "Person",
      name: "Smit Parekh",
    },
    mainEntity: {
      ...
      itemListElement: projects.map((item, index) => ({
        "@type": "ListItem",
        position: index + 1,
        url: `https://www.smitparekh.co.in/project/${formatUrlSlug(
          item.title
        )}`,
        item: {
          "@type": "CreativeWork",
      ...
      <section className="portfolio-nav-section">
        <div className="portfolio__container">
          ...
          <div className="portfolio-filter-dropdown" ref={dropdownRef}>
            ...
            <div
              className={`portfolio-filter-backdrop ${
                dropdownOpen ? "show" : ""
              }`}
            ...
            <div
              className={`portfolio-filter-menu ${dropdownOpen ? "show" : ""}`}
            >
              ...
              <div className="swiper-wrapper">
                {categories.map((category) => (
                  <div className="swiper-slide" key={category.id}>
                    ...
                    >
                      <i
                        className={`uil uil-${getCategoryIcon(
                          category.id
                        )} portfolio-nav__icon`}
                      ></i>
                      <span className="portfolio-nav__tab-text">
                        {category.name}
                      </span>
                    </button>
                  </div>

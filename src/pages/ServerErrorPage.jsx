...
const ServerErrorPage = () => {
  ...
  const serverErrorSchema = {
    ...
    description:
      "We're experiencing technical difficulties. Please try again later or navigate back to the homepage.",
  }
  ...
  return (
    <>
      <SEO
        ...
        canonicalUrl="https://www.smitparekh.co.in/500"
        ...
        <div className="container">
          <div className="error-page__content">
            <div className="error-page__image">
              <i
                className="uil uil-server-network-alt"
                style={{ fontSize: "8rem", color: "var(--first-color)" }}
              ></i>
            ...
            <p className="error-page__description">
              Sorry, we're experiencing some technical difficulties with our
              server. This is our fault, not yours.
            </p>
            <p className="error-page__description">

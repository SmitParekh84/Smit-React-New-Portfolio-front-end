...
const ImageCompressorPage = () => {
    ...
    const toolSchema = {
        ...
        "description": "Compress your images online without losing quality. This free tool reduces file size while maintaining image quality, perfect for websites and social media.",
        "featureList": "Compress images with adjustable quality, Maintain visual quality, Fast processing, Support for multiple file formats, Bulk compression available",
        "creator": {
            "@type": "Person",
            "name": "Smit Parekh"
        }
    ...
    return (
        <>
            <SEO 
                ...
                twitterImage="https://www.smitparekh.studio/images/Image-Compressor-Tool.webp"

  ...
  return (
    <>
      <SEO
        ...
        canonicalUrl="https://www.smitparekh.co.in/terms"
      />
        ...
        <div className="terms-page__container container">
          ...
          <div className="terms-page__content">
            <div className="terms-page__section">
              ...
              <p>
                Welcome to Smit Parekh's portfolio and tools website. These
                Terms and Conditions ("Terms", "Terms and Conditions") govern
                your use of our website located at{" "}
                <a href="https://www.smitparekh.co.in">www.smitparekh.co.in</a>{" "}
                (the "Service") operated by Smit Parekh ("us", "we", or "our").
              </p>
              <p>
            ...
            <div className="terms-page__section">
              ...
              <ul>
                <li>
                  Provide accurate, current, and complete information when using
                  our tools and services
                </li>
                <li>
                  Use the Service in a manner consistent with any and all
                ...
                <li>
                  Not attempt to harm, disrupt, or interfere with the Service or
              ...
              <p>
                Our website offers several free tools, including but not limited
                to Background Remover, LinkedIn Post Generator, QR Code
                Generator, and SEO Analyzer. By using these tools, you agree to:
              </p>
              <ul>
                <li>Use them for personal and lawful purposes only</li>
                <li>
                  Not overload or flood the system with excessive requests
                </li>
                <li>Not attempt to bypass any usage limits or restrictions</li>
                <li>
                  Acknowledge that tools are provided "as is" without any
            ...
            <div className="terms-page__section">
              ...
              <p>
                ...
                exclusive property of Smit Parekh and its licensors. The Service
                ...
                without the prior written consent of Smit Parekh.
              </p>

              <h3>3.2 User Content</h3>
              <p>
                When you upload content to our Service for processing (such as
                images for the Background Remover or URLs for the SEO Analyzer),
                you retain all rights to your content. However, by uploading,
                you grant us a non-exclusive, royalty-free license to use,
                process, and store your content for the purpose of providing the
                Service to you.
              </p>

              <h3>3.3 Portfolio Projects</h3>
              <p>
                The portfolio projects displayed on this website are the
                intellectual property of Smit Parekh unless otherwise stated.
                These projects are presented for informational and demonstration
                purposes only. Unauthorized use, reproduction, or distribution
                of these projects without explicit permission is prohibited.
              </p>
            </div>
            ...
            <div className="terms-page__section">
              ...
              <p>
                In no event shall Smit Parekh, nor its directors, employees,
              ...
              <p>
                Our tools are provided on an "as is" and "as available" basis
                without any warranties, either express or implied, including but
            ...
            <div className="terms-page__section">
              ...
              <p>
                ...
                services that are not owned or controlled by Smit Parekh. We
            ...
            <div className="terms-page__section">
              ...
              <p>
                ...
                of your information when you use the Service. By using our
                Service, you agree to the collection and use of information in
                accordance with our Privacy Policy.
              </p>
              <p>
                For more details about how we handle user data, please refer to
            ...
            <div className="terms-page__section">
              ...
              <p>
                ...
                replace these Terms at any time. We will make reasonable efforts
                to provide notice of any significant changes, but you are
                responsible for regularly reviewing these Terms. Your continued
            ...
            <div className="terms-page__section">
              ...
              <ul className="contact-details">
                <li>
                  <strong>Email:</strong>{" "}
                  <a href="mailto:smitparekh02@gmail.com">

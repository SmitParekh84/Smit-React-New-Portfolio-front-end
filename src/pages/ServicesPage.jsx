...
const ServicesPage = () => {
  ...
  const serviceSchema = {
    ...
    url: "https://www.smitparekh.co.in/services",
    description:
      "Smit Parekh provides Full Stack Web Development, SEO Optimization, Digital Marketing, Social Media Marketing, Video Editing, and Graphic Design services.",
    serviceType: servicesData.map((service) => ({
      ...
      availableChannel: {
        "@type": "ServiceChannel",
        serviceUrl: "https://www.smitparekh.co.in/contact",
        servicePhone: "+91 9537826098",
      },
    })),
    image: {
      "@type": "ImageObject",
      url: "https://www.smitparekh.co.in/images/Smit-Parekh-Services.webp",
      width: "1200",
      height: "630",
    },
    priceRange: "$$",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: "Services",
        item: "https://www.smitparekh.co.in/services",
      },
    ],
  }
  ...
  const faqItems = [
    {
      ...
      answer:
        "I work with businesses of all sizes, from startups to established enterprises, across various industries including technology, e-commerce, education, healthcare, and creative services.",
    },
    {
      question: "How long does it typically take to complete a project?",
      answer:
        "Project timelines vary based on scope and complexity. A simple website might take 2-4 weeks, while a comprehensive marketing strategy with implementation could take 1-3 months. During our initial consultation, I'll provide a detailed timeline specific to your project.",
    },
    {
      question: "Do you offer ongoing maintenance and support?",
      answer:
        "Yes, I offer flexible maintenance packages for websites and digital marketing campaigns. These can include regular updates, performance monitoring, content updates, and technical support to ensure your digital presence remains effective and secure.",
    },
    {
      question: "What makes your services different from other providers?",
      answer:
        "My unique combination of technical expertise and marketing knowledge allows me to deliver solutions that are not only visually appealing but also strategically designed to achieve business goals. I focus on data-driven approaches and maintain transparent communication throughout the process.",
    },
  ]
  ...
  const testimonials = [
    {
      ...
      comment:
        "Smit transformed our digital presence completely. His strategic approach to web development and SEO increased our organic traffic by 200% within just three months.",
    ...
    },
    {
      ...
      comment:
        "Working with Smit was a game-changer for our marketing strategy. His insights and execution helped us reach our target audience more effectively than ever before.",
    ...
    },
    {
      ...
      comment:
        "Smit's creativity and technical skills are unmatched. He created a beautiful website that perfectly represents our brand and has significantly improved our customer engagement.",
  ...
  return (
    <>
      <SEO
        ...
        canonicalUrl="https://www.smitparekh.co.in/services"
        ogImage="https://www.smitparekh.co.in/images/Smit-Parekh-Services.webp"
        twitterImage="https://www.smitparekh.co.in/images/Smit-Parekh-Services.webp"
          ...
          <div className="service-process__timeline">
            ...
            <div className="service-process__item">
              <div className="service-process__item-content">
                ...
                <p className="service-process__step-description">
                  We begin with an in-depth discovery session to understand your
                  business goals, target audience, and specific requirements to
                  tailor the perfect solution.
                </p>
                <ul className="service-process__features">
                  <li>
                    <i className="uil uil-check-circle"></i> Requirement
                    analysis
                  </li>
                  <li>
                    <i className="uil uil-check-circle"></i> Market research
                  </li>
                  <li>
                    <i className="uil uil-check-circle"></i> Competitor analysis
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="service-process__item">
              <div className="service-process__item-content">
                ...
                <p className="service-process__step-description">
                  Based on our findings, I create a comprehensive strategy
                  outlining the approach, timeline, deliverables, and expected
                  outcomes for your project.
                </p>
                <ul className="service-process__features">
                  <li>
                    <i className="uil uil-check-circle"></i> Solution
                    architecture
                  </li>
                  <li>
                    <i className="uil uil-check-circle"></i> Project roadmap
                  </li>
                  <li>
                    <i className="uil uil-check-circle"></i> Resource planning
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="service-process__item">
              <div className="service-process__item-content">
                ...
                <p className="service-process__step-description">
                  With your approval, I execute the strategy with precision,
                  providing regular updates and opportunities for feedback to
                  ensure alignment with your vision.
                </p>
                <ul className="service-process__features">
                  <li>
                    <i className="uil uil-check-circle"></i> Agile methodology
                  </li>
                  <li>
                    <i className="uil uil-check-circle"></i> Regular updates
                  </li>
                  <li>
                    <i className="uil uil-check-circle"></i> Quality assurance
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="service-process__item">
              <div className="service-process__item-content">
                ...
                <p className="service-process__step-description">
                  After implementation, we thoroughly review the results, gather
                  insights, and make necessary optimizations to maximize
                  performance and ROI.
                </p>
                <ul className="service-process__features">
                  <li>
                    <i className="uil uil-check-circle"></i> Performance
                    analysis
                  </li>
                  <li>
                    <i className="uil uil-check-circle"></i> Data-driven
                    improvements
                  </li>
                  <li>
                    <i className="uil uil-check-circle"></i> Ongoing support
                  </li>
                </ul>
              </div>
            </div>
                ...
                <div className="services-testimonial__content">
                  ...
                  <div className="services-testimonial__client">
                    ...
                    <div className="services-testimonial__client-info">
                      <h4 className="services-testimonial__name">
                        {testimonial.name}
                      </h4>
                      <p className="services-testimonial__position">
          ...
          <div className="why-choose__grid grid">
            <div className="why-choose__item">
              ...
              <p className="why-choose__description">
                I deliver high-quality work that meets professional standards
            ...
            <div className="why-choose__item">
              ...
              <p className="why-choose__description">
                I respect deadlines and ensure your projects are completed on
                time, every time.
              </p>
            </div>
            ...
            <div className="why-choose__item">
              ...
              <p className="why-choose__description">
                My solutions are designed to deliver measurable results that
            ...
            <div className="why-choose__item">
              ...
              <p className="why-choose__description">
                I prioritize your needs and maintain open communication
          ...
          <div className="services-faq__container">
            {faqItems.map((item, index) => (
              ...
              >
                ...
                >
                  <h3 className="services-faq__question-text">
                    {item.question}
                  </h3>
      ...
      <section className="cta-services section">
        <div className="container">
          <div className="cta-services__content">
            <h2 className="cta-services__title">
              Ready to Transform Your Digital Presence?
            </h2>
            <p className="cta-services__description">
              Let's collaborate to create solutions that drive real results for
              your business.
            </p>

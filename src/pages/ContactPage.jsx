...
const ContactPage = () => {
  ...
  const contactSchema = {
    ...
    description:
      "Contact Smit Parekh for inquiries regarding web development, digital marketing, and SEO services.",
    mainEntity: {
      "@type": "Person",
      name: "Smit Parekh",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: "Contact",
        item: "https://www.smitparekh.co.in/contact",
      },
    ],
  }
  ...
  const organizationSchema = {
    ...
    name: "Smit Parekh",
    url: "https://www.smitparekh.co.in",
    logo: "https://www.smitparekh.co.in/images/logo.webp",
    contactPoint: {
      "@type": "ContactPoint",
      telephone: contactData.phone,
      contactType: "customer service",
  ...
  return (
    <>
      <SEO
        ...
        canonicalUrl="https://www.smitparekh.co.in/contact"
        structuredData={[contactSchema, breadcrumbSchema, organizationSchema]}
        lastUpdated="2023-10-05"
        language="en-US"
        ogImage="https://www.smitparekh.co.in/images/contact-page.webp"
        twitterImage="https://www.smitparekh.co.in/images/contact-page.webp"
      />
      ...
      <section className="contact-cta">
        <div className="container">
          <div className="contact-cta__content">
            ...
            <p>
              Let's create something amazing together. Reach out today to get
              started!
            </p>
      ...
      <style jsx>{`
        .contact-page-header {
          background: linear-gradient(
            ...
            rgba(var(--first-color-rgb), 0.2) 100%
          );
          padding: 5rem 0 3rem;
          text-align: center;
          margin-bottom: 2rem;
        ...
        .contact-cta {
          background: linear-gradient(
            135deg,
            rgba(var(--first-color-rgb), 0.9) 0%,
            rgba(var(--first-color-rgb), 1) 100%
          );
          padding: 4rem 0;
          margin-top: 2rem;
          text-align: center;

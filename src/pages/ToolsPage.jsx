...
const ToolsPage = () => {
  ...
  const toolsSchema = {
    ...
    image: {
      "@type": "ImageObject",
      url: "https://www.smitparekh.co.in/images/Tools-Page-Image.webp",
      width: "1200",
      height: "630",
    ...
    publisher: {
      ...
      logo: {
        "@type": "ImageObject",
        url: "https://www.smitparekh.co.in/images/logo.webp",
        width: "112",
        height: "112",
      },
    },
    mainEntity: {
      ...
      description:
        "A collection of free online tools for productivity and marketing",
    ...
    keywords:
      "free online tools, productivity tools, marketing tools, background remover, LinkedIn post generator, meta tag checker, free SEO tools",
  }
  ...
  const featuresData = [
    {
      ...
      description:
        "Our tools are designed to automate tedious tasks, reducing hours of manual work to just a few seconds. Increase your productivity with our optimized workflows.",
    },
    {
      icon: "uil-shield-check",
      title: "Enterprise-Grade Quality",
      description:
        "Enjoy professional-level results without the enterprise price tag. Our tools use advanced algorithms to deliver high-quality output comparable to paid solutions.",
    },
    {
      icon: "uil-lock",
      title: "Privacy First Approach",
      description:
        "Your data security is our priority. All processing happens in your browser where possible, and we never store your files on our servers without explicit permission.",
    },
    {
      icon: "uil-analytics",
      title: "Data-Driven Results",
      description:
        "Our tools are built on extensive research and best practices to provide optimal results for your specific use cases and industry standards.",
    },
    {
      icon: "uil-users-alt",
      title: "Built for Professionals",
      description:
        "Created with real-world professional needs in mind, our tools solve genuine pain points faced by marketers, developers, designers, and content creators.",
    },
    {
      icon: "uil-headphones",
      title: "Responsive Support",
      description:
        "Although our tools are free, we provide responsive support to help you maximize their potential. Our documentation and help resources are comprehensive.",
    },
  ]
  ...
  const howItWorksSteps = [
    {
      ...
      description:
        "Browse our collection of free tools and choose the one that meets your specific needs. Each tool is designed to solve a unique professional challenge.",
    },
    {
      title: "Follow Simple Instructions",
      description:
        "Each tool has a user-friendly interface with clear instructions. No technical knowledge required - our tools are accessible to everyone regardless of skill level.",
    },
    {
      title: "Process Your Content",
      description:
        "Upload your files, enter your data, or provide the necessary input. Our advanced algorithms will process your request instantly with optimal results.",
    },
    {
      title: "Download or Use Results",
      description:
        "Once processing is complete, you can download your results, copy generated content, or use the output directly in your projects without restrictions.",
    },
  ]
    ...
    <>
      ...
      >
        ...
        <meta
          ...
          content="https://www.smitparekh.co.in/about"
        />
        <meta
          property="article:published_time"
          content="2023-08-01T08:00:00+00:00"
        />
        <meta
          property="article:modified_time"
          content={`${lastUpdatedDate}T10:15:00+00:00`}
        />

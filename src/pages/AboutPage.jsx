...
const AboutPage = () => {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: "About",
        item: "https://www.smitparekh.co.in/about",
      },
    ],
  }
  ...
  const websiteSchema = {
    ...
    description:
      "Professional website of Smit Parekh, featuring portfolio, skills, services and free tools",
    publisher: {
      "@type": "Organization",
      name: "Smit Parekh",
      logo: {
  ...
  const pageUrl = "https://www.smitparekh.co.in/about"
  const imageUrl = "https://www.smitparekh.co.in/images/Smit-Parekh-About.webp"

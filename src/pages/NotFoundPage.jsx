...
const NotFoundPage = () => {
  ...
  const notFoundSchema = {
    ...
    description:
      "The page you're looking for couldn't be found. Navigate back to the homepage or explore our available tools and services.",
  }
  ...
  return (
    <>
      <SEO
        ...
        canonicalUrl="https://www.smitparekh.co.in/404"

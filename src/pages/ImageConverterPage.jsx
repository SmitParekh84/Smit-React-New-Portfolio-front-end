...
const ImageConverterPage = () => {
  ...
  const toolSchema = {
    ...
    description:
      "Convert images between multiple formats including PNG, JPG, WEBP and more. This free online tool makes format conversion simple and fast with no loss in quality.",
    featureList:
      "Convert images to multiple formats, Maintain original image quality, Fast processing, Support for PNG, JPG, WEBP, and more formats, Batch conversion available",
    creator: {
      "@type": "Person",
      name: "Smit Parekh",
    },
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        item: "https://www.smitparekh.co.in/image-converter",
      },
    ],
  }
  ...
  return (
    <>
      <SEO
        ...
        canonicalUrl="https://www.smitparekh.co.in/image-converter"
